    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <form action="{{ route('admin.broadcasts.store') }}" method="POST" id="broadcast-form" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-5">
                                        ...
                                        <div class="card-body">
                                            <div class="fv-row mb-10">
                                                ...
                                                <input type="text" name="name" id="input-name" class="form-control form-control-solid @error('name') is-invalid @enderror" 
                                                       placeholder="Contoh: Promo Ramadhan 2024" value="{{ old('name') }}" required />
                                        ...
                                        <div class="card-body">
                                            <div class="fv-row mb-7">
                                                ...
                                                <select name="target_type" id="target-type" class="form-select form-select-solid" data-control="select2" data-hide-search="true">
                                                    <option value="all" {{ old('target_type') == 'all' ? 'selected' : '' }}>Semua Pelanggan</option>
                                                    <option value="label" {{ old('target_type') == 'label' ? 'selected' : '' }}>Berdasarkan Label</option>
                                                    <option value="custom" {{ old('target_type') == 'custom' ? 'selected' : '' }}>Pilih Manual</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3 mb-7">
                                                <div class="col-6">
                                                    ...
                                                    <input type="number" name="delay_min" class="form-control form-control-solid" value="{{ old('delay_min', $delayMin) }}" min="1" />
                                                </div>
                                                <div class="col-6">
                                                    <label class="fs-7 fw-bold mb-1">Max Delay (s)</label>
                                                    <input type="number" name="delay_max" class="form-control form-control-solid" value="{{ old('delay_max', $delayMax) }}" min="1" />
                                                </div>
                                            </div>

                                            <div class="fv-row mb-7">
                                                <div class="form-check form-switch form-check-custom form-check-solid">
                                                    <input class="form-check-input" type="checkbox" id="schedule-toggle" name="schedule_type" value="date" />
                                            ...
                                            <div id="schedule-wrapper" class="fv-row mb-7 d-none">
                                                <label class="fs-6 fw-semibold mb-2">Waktu Pengiriman</label>
                                                <input type="text" name="scheduled_at" id="scheduled_at" class="form-control form-control-solid" placeholder="Pilih tanggal & waktu" />
                                            </div>
                                        </div>
                                        <div class="card-footer pt-0">
                                            <button type="submit" class="btn btn-primary w-100">
                                                <span class="indicator-label">Buat Broadcast</span>
                                            </button>
                                        </div>
                                    </div>
                                    <!--end::Settings-->
